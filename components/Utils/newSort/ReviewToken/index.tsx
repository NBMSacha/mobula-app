      ...
      <Flex justify="center" direction={["column", "column", "column", "row"]} mb="10px">
        ...
        >
          <Flex
            ...
            py={["15px", "15px", "30px", "30px"]}
            px={["25px", "25px", "40px", "40px"]}
          >
            <Flex align="center">
              <Flex align="center">
                <Image
                  mr="15px"
                  src={token.logo}
                  h={["30px", "30px", "39px", "39px"]}
                  w={["30px", "30px", "39px", "39px"]}
                />
              ...
              <Flex align="center" px="10px">
                ...
                {token.discord && (
                  <Link _focus={{ boxShadow: "none" }} href={token.discord} target="_blank">
                    <Image
                      mr="10px"
                      h={["18px", "18px", "30px", "30px"]}
                      w={["18px", "18px", "30px", "30px"]}
                      src="/new-discord.png"
                    />
                  </Link>
                )}
                {token.chat.length > 0 ? (
                  <Link _focus={{ boxShadow: "none" }} href={token.chat} target="_blank">
                    <Image
                      h={["16px", "16px", "23px", "23px"]}
                      w={["16px", "16px", "23px", "23px"]}
                      src="/new-tlg.png"
                    />
                  </Link>
                ) : (
            ...
            <Flex align="center" display={["none", "none", "flex", "flex"]}>
              <Flex align="center" px="10px">
                {token.kyc && (
                  ...
                  >
                    <Button variant="primary" mr="15px" borderRadius="8px" py="5px" w="90px" bg="var(--background)">
                      KYC
                    </Button>
                  </Link>
                )}
                {token.audit && (
                  <Link
                    ...
                    _hover={{ textDecoration: "none" }}
                  >
                    <Button variant="primary" borderRadius="8px" py="5px" w="90px" bg="var(--background)">
                      Audit
                    </Button>
                  </Link>
                )}
          ...
          <Flex align="center" display={["flex", "flex", "none", "none"]}>
            <Flex fontSize="11px" align="center" justify="space-between" px="10px" w="90%" mx="auto" mt="5px">
              {token.kyc.length > 0 ? (
                <Link href={token.kyc}>
                  <Button variant="primary" mr="15px" borderRadius="8px" py="5px" w="80px" bg="var(--background)">
                    KYC
                  </Button>
                </Link>
              ) : (
              ...
              {token.chat.length > 0 ? (
                <Link href={token.chat}>
                  <Button variant="primary" borderRadius="8px" py="5px" w="80px" bg="var(--background)">
                    Telegram
                  </Button>
                </Link>
              ) : (
          ...
          <Flex w="100%" p={["15px 25px", "15px 25px", "40px", "40px"]}>
            <Text width="fit-content" fontSize={["10px", "10px", "15px", "15px"]}>
              {token.description}
            </Text>
          </Flex>
          {/* MOBILE CONTRACTS */}
        ...
        <Vote
          voteToken={voteToken}
          token={token}
          updateScoreUtility={setUtilityScore}
          updateScoreMarket={setMarketScore}
          updateScoreTrust={setTrustScore}
          updateScoreSocial={setSocialScore}
