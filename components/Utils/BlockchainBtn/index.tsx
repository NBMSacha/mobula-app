  ...
  return (
    ...
    <Flex className={styles['main-blockchain-container']} w={["100%", "100%", "95%", "95%"]} mx="auto" mb="10px" >
     ...
     <button className={styles["params"]}>
      ...
      <IconButton _focus={{ boxShadow: "none" }} mx={1} variant={display == 'Settings' ? 'secondary' : 'primary'} display={["flex", "flex", "flex", "flex"]}
        onClick={() => {
