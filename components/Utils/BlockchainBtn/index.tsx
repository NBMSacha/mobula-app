    ...
    <Flex className={styles["main-blockchain-container"]} w={["100%", "100%", "95%", "95%"]} mx="auto" mb="10px">
      ...
      >
        <Button
          ...
          w={["80px", "80px", "95px", "110px"]}
          mx={1}
          fontSize={["12px", "12px", "14px", "14px"]}
          display={["flex", "flex", "flex", "flex"]}
          variant={blockchain == "Ethereum" ? "secondary" : "primary"}
        ...
        <Button
          ...
          mx={1}
          fontSize={["12px", "12px", "14px", "14px"]}
          variant={blockchain == "BNB Smart Chain (BEP20)" ? "secondary" : "primary"}
          h={["30px", "30px", "40px", "40px"]}
          alignItems="center"
          justifyContent="center"
          padding="10px"
        ...
        <Button
          ...
          fontSize={["12px", "12px", "14px", "14px"]}
          display={["flex", "flex", "flex", "flex"]}
          variant={blockchain == "Avalanche C-Chain" ? "secondary" : "primary"}
          h={["30px", "30px", "40px", "40px"]}
          alignItems="center"
        ...
        <Button
          ...
          fontSize={["12px", "12px", "14px", "14px"]}
          display={["flex", "flex", "flex", "flex"]}
          variant={blockchain == "Polygon" ? "secondary" : "primary"}
          h={["30px", "30px", "40px", "40px"]}
          alignItems="center"
          justifyContent="center"
          padding="10px"
        ...
        <Button
          ...
          fontSize={["12px", "12px", "14px", "14px"]}
          display={["flex", "flex", "flex", "flex"]}
          variant={blockchain == "Cronos" ? "secondary" : "primary"}
          h={["30px", "30px", "40px", "40px"]}
          alignItems="center"
          justifyContent="center"
          padding="10px"
          ...
          pr="20px"
          borderRadius="10px"
          className={`${styles["blockchain-btn"]} ${styles["onion-btn"]} ${blockchain == "Cronos" ? styles.white : ""}`}
        ...
        <Button
          ...
          fontSize={["12px", "12px", "14px", "14px"]}
          display={["flex", "flex", "flex", "flex"]}
          variant={blockchain == "Arbitrum" ? "secondary" : "primary"}
          h={["30px", "30px", "40px", "40px"]}
          alignItems="center"
          justifyContent="center"
          padding="10px"
          ...
          pr="20px"
          borderRadius="10px"
          className={`${styles["blockchain-btn"]} ${styles["digi-btn"]} ${display == "Arbitrum" ? styles.white : ""}`}
          onClick={() => setBlockchain(blockchain == "Arbitrum" ? "" : "Arbitrum")}
        >
          <Image
            h={["20px", "20px", "28px", "28px"]}
            src="/arbitrum.png"
        ...
        <Button
          ...
          variant={blockchain == "Harmony" ? "secondary" : "primary"}
          h={["30px", "30px", "40px", "40px"]}
          alignItems="center"
          justifyContent="center"
          padding="10px"
