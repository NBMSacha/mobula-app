...
export default function Widget({
  ...
  function easeInExpo(x: number): number {
    return x === 0 ? 0 : Math.ceil(Math.E ** (x / 50000));
  }
  ...
  return (
    <Flex
      ...
      boxShadow="3px 5px 25px 10px var(--widget-shadow)"
      direction="column"
      align="center"
      w={["90%", "90%", "350px", "350px"]}
      position="fixed"
    ...
    >
      ...
      <Flex direction="column" justify="center" w="80%">
        ...
        <Box pt={6} pb={2}>
          <Slider
            ...
            defaultValue={reverseExpo(settings.liquidity)}
            max={1_000_000}
            mt="15px"
        ...
        <Box pt={6} pb={2}>
          <Slider
            aria-label="slider-ex-6"
            defaultValue={reverseExpo(settings.volume)}
            max={1_000_000}
            mt="15px"
      ...
      <Button
        ...
        onClick={() => {
          setVisible(false);
          setSettings({
            liquidity: easeInExpo(liquidity),
            volume: easeInExpo(volume),
            onChainOnly,
            default: false,
          });
        }}
