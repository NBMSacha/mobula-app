    ...
    >
      ...
      >
        <Flex color="var(--text-primary)" align="center" justify="space-between" mt="20px">
          <Input
            ref={inputOutRef}
            onChange={(e) => setSwapOut({ amount: parseFloat(e.target.value), decided: true })}
            value={swapOut.amount}
            type="number"
            w="60%"
            color="none"
            _placeholder={{ color: "none" }}
      ...
      <Flex justify="center" mb={["50px", "50px", "50px", "auto"]}>
        <Button
          ...
          bg={activeStatus.includes(buttonStatus) ? "blue" : "rgb(169,169,169, 0.3)"}
          mt={["15px", "15px", "30px", "30px"]}
          w={["90%", "90%", "90%", "100%"]}
