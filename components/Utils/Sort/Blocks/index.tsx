import { Box, Flex, useColorModeValue, Image, Heading, Text, Button } from "@chakra-ui/react";
                ...
                if(token.alreadyVoted === false ) {
                    return (
                        ...
                        >
                            ...
                            <Button mt="20px" h="40px" w="40%" bg="dark_text_tendance" onClick={() => setDisplayedToken(token.id)}>Analyze</Button>
                        </Box>
                    );
                } 
            })}
