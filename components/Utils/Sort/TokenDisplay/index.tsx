  ...
  return (
    <Flex flexWrap={["wrap", "wrap", "wrap", "nowrap"]} ml={["2rem", "2rem", "5rem"]} mr={["2rem", "2rem", "5rem"]}>
      <Flex direction="column" w={["100%", "100%", "80%"]}>
        <Flex width="100%" align="center" flexWrap={["wrap", "wrap", "nowrap"]}>
          <Flex justify="space-between" width="100%" align="center">
            <Flex align="center">
              <Image width="50px" src={token.logo} mr="20px" />
      ...
      <Flex
        ...
        p="20px"
        pr={["10px", "10px", "10px", "40px"]}
        pl={["10px", "10px", "10px", "40px"]}
        direction="column"
        h="350px"
        ...
        ml={["0px", "0px", "0px", "30px", "100px"]}
        rounded="xl"
      >
        <Flex
          marginTop="0px"
          justifyContent={["space-between"]}
          mr={["30px", "30px", "30px", "0px"]}
        ...
        <Flex mt="30px" justifyContent={["space-between"]}>
          <Button
            ...
            width="49% !important"
            rounded="xl"
            onClick={() => voteToken(true, complete, token, utilityScore, socialScore, trustScore, marketScore)}
          >
            Validate
          </Button>
          <Button
            bg={useColorModeValue("#E9E9E9", "white")}
            color="black"
            h="40px"
            width="49% !important"
            rounded="xl"
            onClick={() => voteToken(false, complete, token, utilityScore, socialScore, trustScore, marketScore)}
          >
            Reject
          </Button>
        </Flex>
