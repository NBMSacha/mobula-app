...
const TopSection = () => {
    ...
    return (
        ...
        <Flex w="90%" direction="column" mt="0px" pb="50px" align="center">
            ...
            <Flex  align="center" justify="center" bg={["none", "none", "none", bg]}  maxWidth="1025px" mt={['30px','30px','0px','0px']} ml={["10px","10px","25px","25px"]} borderRadius="12px" mr={['16px','16px','','']} boxShadow={["none","none","none",`1px 2px 12px 3px ${shadow}`]}>
