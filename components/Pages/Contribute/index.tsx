        ...
        <Flex direction="column" align="center" maxWidth="1500px" mx="auto" >
            ...
            <Flex w={["90%","90%","80%","80%"]} mx="auto" direction={["column","column", "row", "row"]} align="center" justify="space-between" h="auto">
                <Box w={["95%","92%","40%","40%"]} h="100%" pr={["20px","20px","0px","0px"]}>
                    ...
                    <Text className={styles["description"]} fontSize={["12px", "12px", "18px", "18px"]} mt={['10px','10px','20px','20px']} color="var(--text-grey)">Interact with Mobula community: thousands of crypto lovers and builders making decentralization and seamless data access their top priority.</Text>
            ...
            <Flex direction={["column","column", "row", "row"]} w={["90%","90%","80%","80%"]} align="center" mx="auto" justify="space-between" h="auto" mb="100px">
                <Box w={["95%","92%","40%","40%"]} h="100%" pr={["20px","20px","0px","0px"]}>
                    ...
                    <Text className={styles["description"]} fontSize={["12px", "12px", "18px", "18px"]} mt={['10px','10px','20px','20px']} color="var(--text-grey)" >Aanalyze the projects requesting for a listing, vote for or against the validation of their listing, attribute them a score from 0 to 5. </Text>
