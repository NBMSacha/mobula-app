...
function HistoryBox({text}) {
    ...
    return (
        <Flex w="100%" justify="space-between" fontSize={["12px", "12px", "15px", "15px"]}> 
                ...
                <Flex mr="20px" justify="space-between" bg="var(--bg-governance-box)" mb="20px" borderRadius="12px" align="center" ml="10px" boxShadow={`1px 2px 12px 3px var(--shadow)`}>
                    <Button color="green" colorScheme="green" px="10px" mx="auto"borderRadius="10px" _focus={{boxShadow:"none"}}>
                        <Flex align="center" >
