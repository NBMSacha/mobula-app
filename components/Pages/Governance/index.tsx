...
function Governance() {
  ...
  async function getProposals() {
    ...
    try {
      ...
      const nextProposals = await proposalContract.proposals(5);
    ...
    <Flex direction="column" mb="50px" mt="28px" align="center" justify="center">
      ...
      >
        ...
        <Flex
          w={["96%", "90%", "85%", "45%"]}
          maxWidth="730px"
          direction={["column-reverse", "column-reverse", "column-reverse", "column"]}
        >
        ...
        <Box
          w={["100%", "100%", "100%", "50%"]}
          h="200px"
          bg="linear-gradient(180deg,hsla(0,0%,100%,0) 0, var(--background) 70%,var(--background) 100%,#f5f5f5)"
          left="0px"
          position="absolute"
          bottom={["1050px", "1050px", "450px", "400px"]}
        />
      </Flex>
    </Flex>
  );
