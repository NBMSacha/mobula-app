...
function Cards({ }) {
    ...
    return <>
        <Flex  direction="column" align="center" fontSize="Inter" w="28%" mx="auto" p={["","","","20px 35px"]} bg="var(--bg-governance-box)" boxShadow="1px 2px 13px 3px var(--shadow)" borderRadius="12px">
