...
import { getBlockchainFromId, PROTOCOL_ADDRESS, supportedRPCs } from "../../../constants";
    ...
    <Flex direction="column" w="100%" align="center" mt="28px" mb="50px">
      ...
      >
        <Flex w={["100%", "100%", "100%", "75%"]}>
          ...
          <Left
            promote
            firstInput={membersToPromoteOne}
            secondInput={membersToPromoteTwo}
            setFirstInput={setPromoteAddress}
            firstValue={promoteAddress}
          />
          <Mid
            promote={false}
            firstInput={membersToDemoteOne}
            secondInput={membersToDemoteTwo}
            setFirstInput={setDemoteAddress}
            firstValue={demoteAddress}
          />
        </Flex>
        <Flex
          w={["100%", "100%", "100%", "25%"]}
