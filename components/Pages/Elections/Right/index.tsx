        ...
        <Flex w="100%" direction="column" ml={["0px", "0px", "0px", "15px"]} p={["10px", "10px", "10px", "20px 20px 40px 20px"]} boxShadow={`1px 2px 13px 3px var(--shadow)`} bg="var(--bg-governance-box)" borderRadius="12px">
            <Flex align="center" mb={["0px", "0px", "0px", "30px"]} justify="space-between">
                <Flex align="center">
                    ...
                    <Text ml={["10px", "10px", "10px", "15px"]} fontSize={["18px", "18px", "18px", "23px"]}>Profile</Text>
                </Flex>
            ...
            <Box display={[open ? "block" : "none", open ? "block" : "none", open ? "block" : "none", "block"]} >
                ...
                <Text fontSize={["12px", "12px", "14px", "14px"]} color="grey" mb="25px" textOverflow="ellipsis" whiteSpace="nowrap" overflow="hidden">??</Text>
                ...
                required
                />
                <Button _focus={{boxShadow:"none"}} mt="35px" color="white" bg="var(--btn-elections)" boxShadow={`1px 2px 13px 3px var(--shadow)`} fontSize={["11px", "11px", "14px", "14px"]} w="100%" py={["12px", "12px", "12px", "15px"]} borderRadius={["8px", "8px", "8px", "12px"]}>
                    Submit
                </Button>
            </Box>
        </Flex>
