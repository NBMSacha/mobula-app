            ...
            <Flex w="50%" direction="column" >
                ...
                <Flex boxShadow={["none","none","none",`1px 2px 13px 3px var(--shadow)`]} p={["10px","10px","15px","20px"]} direction="column" bg="var(--bg-governance-box)" borderRadius="12px">
                    ...
                    <Textarea 
                        ...
                        mb="25px"
                    />
                    <Button _focus={{boxShadow:"none"}} bg="var(--blue)" boxShadow={`1px 2px 13px 3px var(--shadow)`} fontSize={["11px","11px","14px","14px"]} color="white" w="100%" py={["12px","12px","15px","15px"]} mb="20px" borderRadius={["8px","8px","8px","12px"]}>
                        Submit
                    </Button>
                </Flex>
            </Flex>
