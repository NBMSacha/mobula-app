...
import {
  Flex, Heading, Image, Link, Table, TableContainer, Tbody, Td, Text, Th, Thead, Tr,
...
export default function RecentlyAdded({ tokensBuffer }) {
  ...
  const [settings, setSettings] = useState({
    liquidity: 0, volume: 0, onChainOnly: false, default: true,
  });
      ...
      <div className={styles.dflex}>
        ...
        >
          ...
          <Text display={["none", "none", "none", "flex"]}>
            You can submit your own token (or a token you
            support)
            <Link color="blue" ml="5px">here</Link>
          </Text>
        </Flex>
        <Widget
          settings={settings}
              ...
              return (
                ...
                >
                  <Tr>
                    ...
                    >
                      <Text
                        color={getTokenPercentage(token.price_change_24h) > 0.01 ? "green" : "red"}
                      >
                        {getTokenPercentage(token.price_change_24h) > 0.01
                          ? <TriangleUpIcon mr="5px" /> : <TriangleDownIcon mr="5px" />}
