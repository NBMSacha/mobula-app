...
const ChartBox = ({
  ...
  <Flex
    ...
    borderRadius="15px"
    w="100%"
    px={["10px", "10px", "40px", "40px"]}
    mt="10px"
    pt={["5px", "5px", "40px", "40px"]}
  >
    {/* TOP tools */}
      ...
      <Box display={["none", "none", "none", "block"]} mb="40px">
        ...
        <Flex fontWeight="400px" fontSize={["", "", "", "13px"]}>
          <Button
            ...
            bg={selector === "price" ? "blue" : "var(--btnInfo)"}
            onClick={() => {
              setSelector("price");
            }}
          >
          ...
          <Button
            ...
            bg={selector === "liquidity" ? "blue" : "var(--btnInfo)"}
            onClick={() => {
          ...
          <Button
            ...
            bg={selector === "volume" ? "blue" : "var(--btnInfo)"}
            onClick={() => {
              setSelector("volume");
            }}
          >
          ...
          <Button
            ...
            bg={selector === "rank" ? "blue" : "var(--btnInfo)"}
            onClick={() => {
              setSelector("rank");
            }}
          >
