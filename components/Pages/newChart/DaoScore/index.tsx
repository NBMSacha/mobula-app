     ...
     return (
        ...
        <Flex direction="column" justify="center" align="center" p="10px ">
            ...
            <Flex align="center" mt="0px"  w={["100%"]} mx="auto">
                ...
                <Text fontSize="14px"><Box as="span" color="var(--text-grey)">{baseAsset.utility_score > 0 ? baseAsset.utility_score : "-"}/5</Box> Utility</Text>
            </Flex>
            <Flex align="center" mt="15px" w={["100%"]}>
                ...
                <Text fontSize="14px"><Box as="span" color="var(--text-grey)">{baseAsset.social_score > 0 ? baseAsset.social_score : "-"}/5</Box> Social</Text>
            </Flex>
            <Flex align="center" mt="15px" w={["100%"]}>
                <CircularProgress mr={["5px","15px","15px","15px"]} size="45px" color={baseAsset.trust_score < 3 ? "red" : "green"}  value={Tvalue} />
                <Text fontSize="14px"><Box as="span" color="var(--text-grey)">{baseAsset.trust_score > 0 ? baseAsset.trust_score : "-"}/5</Box> Security</Text>
            </Flex>
            <Flex align="center" mt="15px" w={["100%"]}>
                <CircularProgress mr={["5px","15px","15px","15px"]} size="45px" color={baseAsset.market_score < 3 ? "red" : "green"} value={Mvalue} />
                <Text fontSize="14px"><Box as="span" color="var(--text-grey)">{baseAsset.market_score > 0 ? baseAsset.market_score : "-"}/5</Box> Market</Text>
            </Flex>
        </Flex>
    </Flex>
     )
