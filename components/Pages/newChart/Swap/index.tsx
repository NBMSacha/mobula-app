...
const Swap = ({ baseAsset }) => {
    ...
    return (
        <Flex w="100%" boxShadow={`1px 2px 12px 3px ${shadow}`} bg={["none", "none", "none", bgChart]} direction="column" m="0px 10px" borderRadius="12px" p="30px 30px" mt={["20px", "20px", "20px", "0px"]}>
