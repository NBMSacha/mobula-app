    ...
    return (
        <>
            {losers.map((gainer: any, idx: number) => {
                return (
                    <Tbody  borderBottom={`2px solid ${border}`} fontSize={["12px", "12px", "13px", "15px"]} onClick={() => router.push('/asset/' + getUrlFromName(gainer.name))} _hover={{ background: "var(--box_active)", cursor: "pointer" }}>
