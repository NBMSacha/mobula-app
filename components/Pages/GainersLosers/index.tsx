    ...
    <div className={styles["main-container"]} style={{ maxWidth: "1850px", margin: "auto", marginBottom: "30px" }}>
      <div className={`${styles["both-container"]} ${styles.widths}`} style={{ flexDirection: "column" }}>
        <Heading
          ...
          w="95%"
          className={styles["title-both"]}
          id="topGainer"
          mt="25px"
          mb="20px"
          fontSize="24px"
        >
          {state === "gainers" ? "Top Gainers" : "Top Loosers"}
        </Heading>
        <Flex align="center" justify="space-between" display={["flex", "flex", "none", "none"]} w="90%">
          <Box className={styles["mobile-btn"]} style={{ width: "95%" }}>
            <Button
              ...
              bg={state == "gainers" ? "var(--box_border_active)" : "none"}
              border={state == "gainers" ? "none" : "1px solid rgba(122, 122, 122, 0.1)"}
              boxShadow="1px 2px 13px 3px var(--shadow)"
              px="10px"
              borderRadius="8px"
              mr="10px"
              className={`${styles["btn-loosers"]} ${styles.gainerLooserActive}`}
              style={{ boxShadow: "1px 2px 13px 3px var(--shadow)" }}
              id="loosers"
              onClick={() => {
                setState("gainers");
            ...
            <Button
              _focus={{ boxShadow: "none" }}
              bg={state == "losers" ? "var(--box_border_active)" : "none"}
              border={state == "losers" ? "none" : "1px solid rgba(122, 122, 122, 0.1)"}
              px="10px"
              borderRadius="8px"
              className={styles["btn-loosers"]}
              style={{ boxShadow: "1px 2px 13px 3px var(--shadow)" }}
              id="gainers"
              onClick={() => {
                setState("losers");
