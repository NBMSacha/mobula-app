      ...
      >
        ...
        >
          ...
          <Flex
            ...
            flexDir="column"
            textAlign="center"
            p={["0px 0px", "0px 0px", "0px 30px", "0px 30px"]}
          >
          ...
          {/* BORDER LINE */}
          <Box w="2px" h="100%" bg="var(--daily-border)" />
          {/* BALANCE DESKTOP */}
          <Flex
            display={["none", "none", "none", "flex"]}
            minWidth="540px"
            w={["100%", "100%", "90%", isLessThan11300px ? "50%" : "45%"]}
            direction="column"
            ...
            <Flex direction="column" mb={["", "", "", "60px"]}>
              ...
              <Flex justify="space-between" align="center">
                ...
                <Button
                  ...
                  bg="blue"
                  color="white"
                  w={["80px", "80px", "140px", "140px"]}
                  h={["25px", "25px", "38px", "38px"]}
                  mb={["", "", "", ""]}
                  borderRadius="12px"
                >
                  Claim
          ...
          >
            <Flex direction="column" w="50%" align="start">
              ...
              <Button
                ...
                color="white"
                w="120px"
                boxShadow="1px 2px 12px 3px var(--shaodw)"
                py="6px"
                borderRadius="8px"
                mt="10px"
                fontSize="11px"
