...
function Dashboard() {
  ...
  async function initValues() {
    try {
      ...
      const firstPaidVotes = (await protocolContract.paidFirstVotes(web3React.account)).toNumber();
      const firstGoodVotes = (await protocolContract.goodFirstVotes(web3React.account)).toNumber();
      const firstBadVotes = (await protocolContract.badFirstVotes(web3React.account)).toNumber();
      const finalPaidVotes = (await protocolContract.paidFinalVotes(web3React.account)).toNumber();
      const finalGoodVotes = (await protocolContract.goodFinalVotes(web3React.account)).toNumber();
      const finalBadVotes = (await protocolContract.badFinalVotes(web3React.account)).toNumber();
                ...
                >
                  <Flex direction={["column", "column", "row", "row"]} bg="none" justify="center" w="50%" p="10px">
                    ...
                    <Flex
                      ...
                      position="relative"
                    >
                      <Text mb={2} whiteSpace="nowrap" fontSize={["11px", "11px", "14px", "14px"]} mr="10px">
                        Correct Decisions :
                      </Text>
                      <Flex
                        align="center"
                      ...
                      >
                        {" "}
                        {firstGoodChoice} <Icon mb="4px" ml="5px" as={ThumbsUp} />
                      </Flex>
                    </Flex>
                    <Flex
                      color="red"
                    ...
                    >
                      ...
                      >
                        {" "}
                        {firstBadChoice} <Icon mb="0px" ml="5px" as={ThumbsDown} />
                      </Flex>
                    </Flex>
                    ...
                    >
                      ...
                      >
                        {" "}
                        {finalGoodChoice} <Icon mb="4px" ml="5px" as={ThumbsUp} />
                      </Flex>
                    </Flex>
                    <Flex
                      color="red"
                      ...
                      position="relative"
                    >
                      <Text whiteSpace="nowrap" mb={2} fontSize={["11px", "11px", "14px", "14px"]} mr="10px">
                        Wrong Decisions :
                      </Text>
                      <Flex
                        align="center"
                      ...
                      >
                        {" "}
                        {finalBadChoice} <Icon mb="0px" ml="5px" as={ThumbsDown} />
                      </Flex>
                    </Flex>
                  </Flex>
                  ...
                  >
                    ...
                    <Button
                      ...
                      onClick={async (e) => {
                        ...
                        try {
                          ...
                          alert.error("You must connect your wallet to access the Dashboard.");
                        }
                        try {
                    ...
                    <Box fontSize="15px" mb={5} mt={5} w="150px">
                      <Text mb={0} mt={0} textAlign="center" fontSize="11px" bottom="60px">
                        {" "}
                        The Protocol currently owes you <b>{`${firstTokensOwed + finalTokensOwed}  $MOBL`}</b>
                      </Text>
                    </Box>
                  </Flex>
                </Flex>
              ...
              >
                <Flex direction="column" w="50%">
                  <Box fontSize="15px" pt="10px" pl="10px">
                    <Text color="none" fontSize="12px" mb={1}>
                      MATIC for DAO members
                    </Text>
                    <Text fontWeight="800" mb="10px" fontSize={["13px", "13px", "15px", "17px"]} color="#16C784">
                      {countdownValue}
                    </Text>
                  </Box>
                  <Box h="1px" w="98%" bg="var(--box_border)">
                    {" "}
                  </Box>
                  <Box fontSize="15px" pl="10px" mb={5}>
                    <Text textAlign="start" fontSize={["13px", "13px", "15px", "15px"]} color="#909090" mt={2} mb={1}>
                      You already claimed
                    </Text>
                    <Text fontSize={["14px", "14px", "16px", "18px"]} textAlign="start">
                      {claimed} MATIC
                    </Text>
                  </Box>
                </Flex>
              ...
              >
                <Flex justify="space-between">
                  <h2 className={styles["dao-title"]} style={{ alignItems: "start" }}>
                    DAO
                    <span className={styles.faucet}>Faucet</span>
                  </h2>
                  <Box fontSize="15px">
                    <Text textAlign="end" fontSize="14px" opacity=".6" color="#909090">
                      You already claimed
                    </Text>
                    <Text fontSize="16px" color=" #909090" fontWeight="600" textAlign="end">
                      {claimed} MATIC
                    </Text>
                  </Box>
                </Flex>
                <Box w="95%" textAlign="start" mt="30px">
                  <Box fontSize="13px">
                    ...
                    <Text color="#D3D3D3" mb={2}>
                      MATIC for DAO members
                    </Text>
                  </Box>
                </Box>
                <Spacer />
                <Flex width="100%" justifyContent={["center", "center", "center", "right"]}>
                  <Button
                    h="45px"
                    px="12px"
                    _focus={{ boxShadow: "none" }}
