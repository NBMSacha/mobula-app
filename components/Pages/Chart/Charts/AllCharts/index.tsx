    ...
    <Box w={["95%", "95%", "95%", "45%"]} mb={["30px"]} mx="auto">
      ...
      <Box color="grey" bg={hiddenTitles.includes(title) ? bg : bg} w="100%" borderRadius="18px" position="relative">
        <>
          ...
          {!hiddenTitles.includes(title) ? (
            <Flex borderRadius="18px" boxShadow={`1px 2px 12px 3px ${shadow}`} position="relative">
              {visible && (
                <Spinner
                  thickness='4px'
                  speed='0.65s'
              ...
              <canvas style={{ borderRadius: "18px", borderRight: `2px solid rgba(0,0,0,${opacity})`, borderLeft: `2px solid rgba(0,0,0,${opacity})`, borderBottom: `7px solid rgba(0,0,0,${opacity})` }} id={`${title}-${idx}`} width="270px" height="100px"></canvas>
            </Flex>
          ) : (
