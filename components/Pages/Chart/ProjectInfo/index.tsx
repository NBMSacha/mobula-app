...
import { Flex, Button, useColorModeValue, Link, Spacer, Text, Box } from "@chakra-ui/react"
    ...
    return (
        <div className={styles["main-container"]}>
            ...
            <Flex className={styles["right"]} ref={refContract} id="contract">
                ...
                <Flex p="5px" wrap={["wrap", "wrap", "wrap", "nowrap"]} direction={["row", "row", "row", "column"]} justify="top" h={"220px"} className={styles["scroller"]}>
                    {token.contracts.map((contract: string, idx: number) => {
                        return <Box w="90%" ml="0px">
                            <Contract contract={contract} blockchain={token.blockchains[idx]}></Contract>
                        </Box>
                    })}
                </Flex>
