        ...
        <TableContainer bg="var(--table)" display="flex" flexDirection="column" alignItems="center">
          ...
          <Table style={{ minWidth: "1220px" }} className={styles["table-style"]}>
            <Thead
              ...
              borderBottom="2px solid var(--box_border)"
              color="var(--text-grey)"
            >
              <Tr className={styles[""]}>
                <Th
                  ...
                  maxWidth="100px"
                  isNumeric
                  className={`${styles.ths} ${styles.removes}`}
                  minWidth={["220px", "220px", "220px", ""]}
                >
                  Rank
                  <IconButton
                    p="5px"
                ...
                <Th
                  ...
                  className={`${styles.ths} ${styles["asset-title-start"]}`}
                  bg="var(--tables)"
                  zIndex="33"
                  style={{ background: "var(--table)" }}
                >
                  Asset
                </Th>
                <Th
                  ...
                  textTransform="capitalize"
                  isNumeric
                  p={["15px 5px", "15px 5px", 6, 6]}
                  px={["5px", "5px", "20px", "20px"]}
                ...
                <Th
                  ...
                  textTransform="capitalize"
                  isNumeric
                  className={`${styles.ths} ${styles.nowrap}`}
                  px={["5px", "5px", "20px", "20px"]}
                  ref={percentageRef}
                >
                ...
                <Th
                  ...
                  fontFamily="Inter"
                  textTransform="capitalize"
                  className={`${styles.ths} ${styles["center-social"]}`}
                >
                  Socials
                </Th>
                <Th
                  ...
                  fontFamily="Inter"
                  textTransform="capitalize"
                  className={`${styles.ths} ${styles["chart-title-center"]}`}
                >
                  Chart
                </Th>
              </Tr>
