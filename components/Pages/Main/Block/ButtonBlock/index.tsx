      ...
      <Flex className={styles["blockchain-container"]}>
        <Flex align="center">
          <Button
            ...
            variant={display == "Top 100" ? "secondary" : "primary"}
          ...
          <Button
            ...
            _focus={{ boxShadow: "none" }}
            fontSize={["12px", "12px", "14px", "14px"]}
            variant={display == "My Assets" ? "secondary" : "primary"}
            h={["30px", "30px", "40px", "40px"]}
            display="flex"
            alignItems="center"
            justifyContent="center"
        ...
        >
          <Button
            ...
            fontSize={["12px", "12px", "14px", "14px"]}
            display="flex"
            variant={display == "Ethereum" ? "secondary" : "primary"}
            h={["30px", "30px", "40px", "40px"]}
            alignItems="center"
            justifyContent="center"
            padding={["5px", "5px", "8px", "8px"]}
          ...
          <Button
            ...
            mx={1}
            fontSize={["12px", "12px", "14px", "14px"]}
            variant={display == "BNB Smart Chain (BEP20)" ? "secondary" : "primary"}
            h={["30px", "30px", "40px", "40px"]}
            alignItems="center"
            justifyContent="center"
            padding={["5px", "5px", "8px", "8px"]}
          ...
          <Button
            ...
            mx={1}
            fontSize={["12px", "12px", "14px", "14px"]}
            variant={display == "Avalanche C-Chain" ? "secondary" : "primary"}
            h={["30px", "30px", "40px", "40px"]}
            alignItems="center"
            justifyContent="center"
            padding={["5px", "5px", "8px", "8px"]}
            borderRadius="8px"
            className={`${styles["blockchain-btn"]} ${display == "Avalanche C-Chain" ? styles.white : ""}`}
          ...
          <Button
            ...
            fontSize={["12px", "12px", "14px", "14px"]}
            display="flex"
            variant={display == "Polygon" ? "secondary" : "primary"}
            h={["30px", "30px", "40px", "40px"]}
            alignItems="center"
            justifyContent="center"
            padding={["5px", "5px", "8px", "8px"]}
            borderRadius="8px"
            className={`${styles["blockchain-btn"]}  ${display == "Polygon" ? styles.white : ""}`}
          ...
          <Button
            ...
            fontSize={["12px", "12px", "14px", "14px"]}
            display="flex"
            variant={display == "Cronos" ? "secondary" : "primary"}
            h={["30px", "30px", "40px", "40px"]}
            alignItems="center"
            justifyContent="center"
            padding={["5px", "5px", "8px", "8px"]}
          ...
          <Button
            ...
            fontSize={["12px", "12px", "14px", "14px"]}
            display="flex"
            variant={display == "Arbitrum" ? "secondary" : "primary"}
            h={["30px", "30px", "40px", "40px"]}
            alignItems="center"
            justifyContent="center"
            padding={["5px", "5px", "8px", "8px"]}
          ...
          <Button
            ...
            variant={display == "Harmony" ? "secondary" : "primary"}
            h={["30px", "30px", "40px", "40px"]}
            alignItems="center"
            justifyContent="center"
            padding="10px"
            ...
            pr="20px"
            borderRadius="10px"
            className={`${styles["blockchain-btn"]} ${styles["digi-btn"]} 
        ...
        <Flex align="center">
          ...
          <IconButton
            mx={1}
            variant={display == "Settings" ? "secondary" : "primary"}
            border="1px solid var(--box_border)"
            display={["flex"]}
            onClick={() => {
