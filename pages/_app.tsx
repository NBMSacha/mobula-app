...
export const ThemeProvider = ({ children }) => {
  ...
  const setColorMode = (newValue: string) => {
    ...
    root?.style.setProperty(
      "--gradient",
      newValue == "dark"
        ? "linear-gradient(180deg, rgba(9, 12, 26, 0.27) 0%, rgba(18, 21, 34, 0) 170.92%, rgba(63, 74, 123, 0) 170.94%)"
        : "linear-gradient(180deg, rgba(9, 12, 26, 0.01) 0%, rgba(18, 21, 34, 0) 170.92%, rgba(63, 74, 123, 0) 170.94%)"
    );
    ...
    root?.style.setProperty(
      "--dailybox_inactive",
      newValue == "dark"
        ? "linear-gradient(180deg, #5C7DF9 37.08%, rgba(92, 125, 249, 0) 37.55%)"
        : "linear-gradient(180deg, #5C7DF9 37.08%, rgba(92, 125, 249, 0) 37.55%)"
    );
    root?.style.setProperty(
      "--dailybox_active",
      newValue == "dark"
        ? "linear-gradient(180deg, #43D19B 37.08%, #131727 37.55%)"
        : "linear-gradient(180deg, #43D19B 37.08%, #F5F5F5 37.55%)"
    );
    ...
    root?.style.setProperty(
      "--data-gradient",
      newValue == "dark"
        ? "linear-gradient(180deg, rgba(92, 125, 249, 0.19) 0%, rgba(17, 21, 36, 0.09) 77.55%, rgba(18, 22, 38, 0) 100%);"
        : "linear-gradient(180deg, rgba(92, 125, 249, 0.03) 0%, rgba(17, 21, 36, 0.09) 77.55%, rgba(18, 22, 38, 0) 100%)"
    );
    ...
    root?.style.setProperty(
      "--box_border",
      newValue == "dark" ? "rgba(122, 122, 122, 0.1)" : "rgba(122, 122, 122, 0.1)"
    );
    ...
    root?.style.setProperty(
      "--text-footer-text",
      newValue == "dark" ? "rgba(88, 102, 126, 0.8)" : "rgba(0, 0, 0, 0.8)"
    );
  ...
  return (
    <ChakraProvider resetCSS theme={themeUltime}>
      <Head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Inter:wght@400;600&family=Poppins:ital,wght@0,200;0,300;0,400;0,500;0,600;1,100;1,200;1,300;1,400;1,500;1,600&family=Ubuntu&display=swap"
          rel="stylesheet"
        />
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-225383575-4" />
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-44ZEDM6VY3" />
