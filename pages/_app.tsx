...
export const ThemeProvider = ({ children }) => {
  ...
  const setColorMode = (newValue: string) => {
    ...
    root?.style.setProperty("--bg-partner", newValue == 'dark' ? "#171B2B" : "#E5E5E5");
    ...
    root?.style.setProperty("--box_active", newValue == 'dark' ? "#273051" : "#ededed");
    root?.style.setProperty("--btn_token", newValue == 'dark' ? "#273051" : "#FAFAFA");
